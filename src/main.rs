...
trait Permeate {
    fn permeate(
        &self,
        solvent1: &mut Solvent,
        solvent2: &mut Solvent
    );
}
...
impl Permeate for Membrane {
    fn permeate(
        ...
        solvent1.o2_count = solvent1.o2_count - (o2_forward as i128);
        solvent2.o2_count = solvent2.o2_count - (o2_reverse as i128);

        solvent1.o2_count = solvent1.o2_count + (o2_reverse as i128);
        solvent2.o2_count = solvent2.o2_count + (o2_forward as i128);
    }
...
fn main() {
    ...
    let mut extrasol = Solvent {
        o2_count: 10000
    };

    let mut periplasm = Solvent {
        o2_count: 10
    };

    let mut cytosol = Solvent {
        o2_count: 5
    };
    ...
    loop {
        ...
        println!("{},{},{},{}", cycle, extrasol.o2_count, periplasm.o2_count, cytosol.o2_count);
